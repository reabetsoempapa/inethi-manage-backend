...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('warning_daily_data_usage', models.FloatField(blank=True, null=True)),
                ('warning_hourly_data_usage', models.FloatField(blank=True, null=True)),
                ('warning_daily_speed', models.FloatField(blank=True, null=True)),
                ('warning_hourly_speed', models.FloatField(blank=True, null=True)),
                ('warning_daily_rtt', models.IntegerField(blank=True, null=True)),
                ('warning_hourly_rtt', models.IntegerField(blank=True, null=True)),
                ('warning_daily_uptime', models.IntegerField(blank=True, null=True)),
                ('warning_hourly_uptime', models.IntegerField(blank=True, null=True)),
